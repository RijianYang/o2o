...
public class DesUtil {
    ...
    public static void main(String[] args) {
        String username = getEncryptString("work");
        String mysqlPsd = getEncryptString("Ago20180101!");
//        String redisPsd = getDecryptString("Class36Team3");
        System.out.println(username);
        System.out.println(mysqlPsd);
//        System.out.println(redisPsd);
    }
