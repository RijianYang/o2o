...
$("#submit").click(function() {
    ...
    if (isPassCheck) {
        modifyPassword(username, password, newPassword, userType, verifyCode);
    }
 ...
 * @param userType
 */
function modifyPassword(username, password, newPassword, userType, verifyCode) {
    jqxhr = $.ajax({
        url: "/o2o/localAuth/modifyPassword",
